...
# Introduction
The goal of this file is to arrange gene-centric *Caenorhbaditis* RNA-seq data from the modENCODE project ([Gerstein *et al* 2010](https://pubmed.ncbi.nlm.nih.gov/21177976/), provided by LaDeana Hillier in Dr. Bob Waterson's lab at UW). 
...
pacman::p_load("tidyverse","data.table", "magrittr","edgeR","matrixStats","cowplot","ggthemes","gprofiler2","limma","tximport", "paletteer", "knitr")
